...
export interface WeatherResultViewProps {
  data: any;
}

export const WeatherResultView: React.FC<WeatherResultViewProps> = React.memo(({ data }) => {
...
WeatherResultView.displayName = 'WeatherResultView';
