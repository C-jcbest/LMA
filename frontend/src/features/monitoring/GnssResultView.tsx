...
export interface GnssResultViewProps {
  data: any;
}

export const GnssResultView: React.FC<GnssResultViewProps> = React.memo(({ data }) => {
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="border border-neutral-200/90 rounded-lg bg-white h-56 max-h-56 overflow-y-auto overscroll-contain shadow-xs">
...
GnssResultView.displayName = 'GnssResultView';
