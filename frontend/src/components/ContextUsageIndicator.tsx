  ...
  return (
    <Popover.Root>
      <Popover.Trigger asChild>
        <button
          type="button"
          className="relative flex h-8 w-8 cursor-pointer items-center justify-center rounded-xl text-neutral-500 transition-colors hover:bg-neutral-100 hover:text-neutral-800 focus:outline-none shrink-0"
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          align="end"
          sideOffset={12}
          className="z-40 w-72 rounded-2xl border border-neutral-200 bg-white p-4 text-xs shadow-[0_18px_45px_rgba(0,0,0,0.14)] animate-in fade-in zoom-in-95 duration-150 focus:outline-none"
        >
